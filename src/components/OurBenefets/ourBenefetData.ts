interface OurBenefetsDataProps {
    icon: string;
    title: string;
    desc: string;
}

export const ourBenefetData :OurBenefetsDataProps[] = [
    {
