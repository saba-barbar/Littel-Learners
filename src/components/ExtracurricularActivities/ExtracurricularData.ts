...
export const ExtracurricularData :ExtracurricularDataProps[] =[
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon2.svg"  ,    
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon3.svg"  ,    
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon4.svg"  ,    
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon5.svg"  ,    
        title: "Science Club",
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon6.svg"  ,    
