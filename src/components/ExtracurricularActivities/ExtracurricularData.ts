...
export const ExtracurricularData :ExtracurricularDataProps[] =[
    {
        icon:"/icons/ExtracurricularIcon/Icon1.webp"  ,    
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon2.webp"  ,    
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon3.webp"  ,    
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon4.webp"  ,    
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon5.webp"  ,    
        title: "Science Club",
    ...
    {
        icon:"/icons/ExtracurricularIcon/Icon6.webp"  ,    
